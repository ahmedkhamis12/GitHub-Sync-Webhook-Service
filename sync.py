...
#     if not repo_url:
#         return None
#     # بتجيب اسم الريبو من رابط الجيت، مثلاً "odoo-project.git" تبقى "odoo-project"
#     return repo_url.split("/")[-1].replace(".git", "")

# # بنقرأ أسماء الريبو من المتغير REPOS في .env
# REPOS = {}
...
#     repo_dir = f"/repos/{extract_repo_name(repo_url)}" if repo_url else None
